    ...
    var config = {
        ...
        files: {
            ...
            vendor_js: [
                ...
                '<%= paths.vendor %>/ng.cork.pubsub/dist/ng.cork.pubsub.js',
                '<%= paths.vendor %>/ng.cork.ui.keys/dist/ng.cork.ui.keys.js',
                '<%= paths.vendor %>/ng.cork.ui.focus-on/dist/ng.cork.ui.focus-on.js',
                '<%= paths.vendor %>/ng.cork.ui.enter-click/dist/ng.cork.ui.enter-click.js',
                '<%= paths.vendor %>/ng.cork.ui.stop-propagation/dist/ng.cork.ui.stop-propagation.js',
        ...
        vars: {
            ...
            ngNamespace: 'ng.cork.input-tags',
            ...
            docs: {
                ...
                imageLink: 'http://cork-labs.org/projects/ng.cork.input-tags',
                ...
                examplesScripts: [
                    ...
                    'vendor/ng.cork.throttling/dist/ng.cork.throttling.js',
                    'vendor/ng.cork.pubsub/dist/ng.cork.pubsub.js',
                    'vendor/ng.cork.ui.keys/dist/ng.cork.ui.keys.js',
                    'vendor/ng.cork.ui.focus-on/dist/ng.cork.ui.focus-on.js',
                    'vendor/ng.cork.ui.enter-click/dist/ng.cork.ui.enter-click.js',
                    'vendor/ng.cork.ui.stop-propagation/dist/ng.cork.ui.stop-propagation.js',
                    'vendor/ng.cork.deep/dist/ng.cork.deep.js',
                    'src/lib/<%= vars.ngNamespace %>/inputTags.js',
